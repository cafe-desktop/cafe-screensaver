...
/* The idea here is to be able to run cafe-screensaver-dialog without any setuid bits.
         ...
         gboolean    verbose)
{
	...
	if (pid == 0)
	{
		...
		execlp (PASSWD_HELPER_PROGRAM, PASSWD_HELPER_PROGRAM, "cafe-screensaver", user, NULL);
		if (verbose)
		{
