...
# endif
	...
	if (! XQueryExtension (CDK_DISPLAY_XDISPLAY (cdk_display_get_default ()), XF86_VIDMODE_NAME, &op, &event, &err))
	{
...
# ifdef HAVE_XF86VMODE_GAMMA
		...
		if (! XF86VidModeQueryVersion (CDK_DISPLAY_XDISPLAY (cdk_display_get_default ()), &major, &minor))
		{
